...
class VectorDB:
    ...
    def __init__(self, embedding_dim: int, index_type: str = 'Flat', collections_name: str = 'default'):
    ...
    def search(self, query_vector: np.ndarray, top_k: int = 5, log_time: bool = False) -> List[Vector]:
        if log_time:
            import time
